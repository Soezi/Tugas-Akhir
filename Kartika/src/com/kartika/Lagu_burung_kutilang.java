...
public class Lagu_burung_kutilang extends Activity {
	private MediaPlayer MPlayer;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_lagu_burung_kutilang);
	...
	private void buka_file_suara() {
		try {
			MPlayer = MediaPlayer.create(this, R.raw.burung_kutilang);
		} catch (Throwable t) {
			error_(t);
		}
	}
