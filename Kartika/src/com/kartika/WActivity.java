...
public class WActivity extends Activity implements
...
stop();
MPlayer.start();
tombol_suara.setImageResource(R.drawable.item_w_2);
tombol_suara.setEnabled(false);
}

private void stop() {
MPlayer.stop();
tombol_suara.setImageResource(R.drawable.item_w_1);
try {
	MPlayer.prepare();
	MPlayer.seekTo(0);
...
try {
	MPlayer = MediaPlayer.create(this, R.raw.w);
